    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReaderCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReaderCategoryId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    ResearchTopic = table.Column<string>(type: "text", nullable: true),
                    LibraryId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorEntityItemEntity", x => new { x.AuthorsId, x.ItemsId });
                    table.ForeignKey(
                        name: "FK_AuthorEntityItemEntity_Authors_AuthorsId",
                        column: x => x.AuthorsId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorEntityItemEntity_Items_ItemsId",
                        column: x => x.ItemsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Loanable = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ItemCopyId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loans_ItemCopies_ItemCopyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorEntityItemEntity_ItemsId",
                table: "AuthorEntityItemEntity",
                column: "ItemsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Readers_ReaderCategoryId",
                table: "Readers",
