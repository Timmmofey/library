...
namespace Library.Core.Abstaction
{
    public interface ILoanRepository
    {
        ...
        Task<List<Loan>> SearchLoansAsync(Guid? itemCopyId, Guid? readerId, Guid? librarianId, DateTime? issueDate, DateTime? dueDate, DateTime? returnDate, bool? lost); // Поиск займов по параметрам
