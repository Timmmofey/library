...
namespace Library.Core.Abstaction
{
    public interface IReaderRepository
    {
        ...
        Task<Guid> AddReader(Reader reader);
        ...
        Task<List<ItemCopyDto1>> GetPublicationsByReaderAndLibraryRegistrationAsync56(
                Guid readerId,
                DateTime startDate,
                DateTime endDate,
        ...
        Task<List<ItemCopyDto1>> GetItemCopiesReceivedOrWithdrawnWithDetailsAsync11(DateTime startDate, DateTime endDate, bool includeReceived = true, bool includeWithdrawn = false);
